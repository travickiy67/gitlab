...
**После регистрации второго ранера с тегом, у меня запуcтилось параллельно test и build  
...
```
**Такой вариант тоже сработал, убрал из этапов build и поставил как вторую задачу в test.**  
...
**Но есть более продвинутые варианты с расспаралеливанием процессов с использованием операторов.**
